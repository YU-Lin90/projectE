<script src="./API/Log/CheckLoginScript.js"></script><script>checkLogin(1);</script>
...
<link rel="stylesheet" href="./StyleSetting/Product/style.css">
...
<div class="edit-form hidden">
    <form action="" name="form1">
        ...
        <input style="width:100%;"  type="number" class="price" name="price" value="">
...
<script>
    ...
    function deleteProduct(e) {
        ...
        if (confirm("確定要刪除這個商品?")) {
            ...
            fd.append('state', 0)
            fetch('./API/Product/simple-product-admin-api.php', {
                method: 'POST',
                body: fd
